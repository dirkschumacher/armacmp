...
* `<-` this assignment operator creates a new variable for the first time and assigns it a value. It cannot be used to reassign a value.
* `=` the equal assignment operator is used to reassign a value to an already defined variable.
